...
if yes_or_no("Does your region experience prolonged and dangerous heat waves?\n"):
    key="extreme heat"
    hazard_dict[key]=master_hazard_dict[key]
if yes_or_no("Does your region experience prolonged and dangerous cold snaps?\n"):
    key="extreme heat"
    hazard_dict[key]=master_hazard_dict[key]    
if yes_or_no("Does your region experiences heavy, damaging, snow storms or snow accumulation?\n"):
    key="extreme snow"
    hazard_dict[key]=master_hazard_dict[key]
...
#        key="erosion"
#        hazard_dict[key]=master_hazard_dict[key]
if yes_or_no("Is your region prone to wildfires or smoke from wildfires?\n"):
        key="wildfire"
        hazard_dict[key]=master_hazard_dict[key]
...
print("\n")
print("Now let's see if we can describe your building in some more detail!\n")
...
for c in master_building_component_dict:
    if yes_or_no("Is "+c+" a major structural or system component of your building?"):
        print(c)
...
for component in building_component_dict:
    ...
    if 'other' in building_component_dict[component]: #extend list with any custom hazards provided by user.
        ...
        while True:
            token=input("->")
            if token != "done":
                building_component_dict[component].append(token)  #Get user-inputted hazard and assign default 'other' hazard information to new, user-defined hazard.
        else:
            break   
